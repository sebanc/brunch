...
)
{
	...
	PHYDM_DBG(p_dm_odm, ODM_COMP_INIT, ("===> odm_read_and_config_mp_8192e_agc_tab\n"));
...
)
{
	...
	PHYDM_DBG(p_dm_odm, ODM_COMP_INIT, ("===> odm_read_and_config_mp_8192e_phy_reg\n"));
...
)
{
	...
	PHYDM_DBG(p_dm_odm, ODM_COMP_INIT, ("===> odm_read_and_config_mp_8192e_phy_reg_pg\n"));
