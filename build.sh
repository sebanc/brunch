...
cd rootfs
curl -L https://dl.google.com/chromeos/rammus/14324.62.0/stable-channel/chromeos_14324.62.0_rammus_stable-channel_full_mp-v2.bin-gyywimtdgqydg2gwhghbycsx5bkozyok.signed -o ./update.signed
...
git clone --depth=1 -b main git://git.kernel.org/pub/scm/linux/kernel/git/firmware/linux-firmware.git
cd ./linux-firmware
