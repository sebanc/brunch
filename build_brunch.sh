...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/rammus/15437.61.0/stable-channel/chromeos_15437.61.0_rammus_stable-channel_full_mp-v3.bin-gy2dsyjxg43ggyeonm2wgjo7okymwpqn.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
...
cp -r ./external-drivers/backport-iwlwifi-core79 ./chroot/tmp/backport-iwlwifi || { echo "Failed to build external iwlwifi module for kernel $kernel"; exit 1; }
