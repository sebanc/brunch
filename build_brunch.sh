...
cd rootfs
curl -L https://dl.google.com/chromeos/rammus/14989.85.0/stable-channel/chromeos_14989.85.0_rammus_stable-channel_full_mp-v2.bin-gyztcmzqgvsdiprwpl2ihirslcotgvcu.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
