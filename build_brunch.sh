...
if [ -f ../chromiumos-stage3/chromiumos_stage3.tar.gz ]; then
	...
	curl -L https://github.com/sebanc/chromiumos-stage3/releases/download/r146-20260401/chromiumos_stage3_r146_20260401.tar.gz -o ./out/chromiumos_stage3.tar.gz || { echo "Failed to download the brunch toolchain"; exit 1; }
fi
...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/reven/16610.52.0/stable-channel/chromeos_16610.52.0_reven_stable-channel_full_RevenMPKeys-v10.bin-gy4wmmlbmeytllbgbuismp64x2x2uyde.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
