...
#ifdef CONFIG_RTW_NAPI
#if (LINUX_VERSION_CODE < KERNEL_VERSION(6, 1, 0) && (!defined(RHEL_RELEASE_CODE))) || (LINUX_VERSION_CODE < KERNEL_VERSION(6, 1, 0) && (defined(RHEL_RELEASE_CODE) && RHEL_RELEASE_CODE <= 2305))
