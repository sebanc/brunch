# This patch brings support for some macbooks touchpads

ret=0

cat >/roota/etc/gesture/60-macbook-touchpad.conf <<GESTURE
Section "InputClass"
...
cat >/roota/lib/udev/rules.d/60-evdev-macbook-touchpad.rules <<UDEVEVDEV
...
cat >/roota/lib/udev/rules.d/90-powerd-macbook-touchpad.rules <<UDEVPOWERD
