...
cd rootfs
curl -L https://dl.google.com/chromeos/rammus/15054.114.0/stable-channel/chromeos_15054.114.0_rammus_stable-channel_full_mp-v2.bin-gyztiojrmjrdilum5ymhfgr3cgslzqir.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
