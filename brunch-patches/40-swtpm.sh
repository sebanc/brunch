...
script
  LD_LIBRARY_PATH=/usr/libswtpm /usr/libswtpm/ld-linux-x86-64.so.2 /usr/bin/swtpm chardev --daemon --vtpm-proxy --tpm2 --tpmstate dir=/mnt/stateful_partition/brunch/swtpm --ctrl type=tcp,port=10001 --flags startup-clear
