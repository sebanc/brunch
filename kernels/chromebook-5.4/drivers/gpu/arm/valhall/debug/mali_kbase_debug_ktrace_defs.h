...
#if defined(CONFIG_MALI_VALHALL_ENABLE_TRACE) || defined(CONFIG_MALI_VALHALL_SYSTEM_TRACE)
...
#ifdef CONFIG_MALI_VALHALL_SYSTEM_TRACE
#define KBASE_KTRACE_TARGET_FTRACE 1
#else /* CONFIG_MALI_VALHALL_SYSTEM_TRACE */
#define KBASE_KTRACE_TARGET_FTRACE 0
#endif /* CONFIG_MALI_VALHALL_SYSTEM_TRACE */

#ifdef CONFIG_MALI_VALHALL_ENABLE_TRACE
#define KBASE_KTRACE_TARGET_RBUF 1
#else /* CONFIG_MALI_VALHALL_ENABLE_TRACE*/
#define KBASE_KTRACE_TARGET_RBUF 0
#endif /* CONFIG_MALI_VALHALL_ENABLE_TRACE */
