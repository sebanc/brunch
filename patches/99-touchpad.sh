...
# An exeperimental alternative touchpad configuration can be activated by using the option "alt_touchpad_config"
# An second alternative touchpad configuration can be activated by using the option "alt_touchpad_config2"
...
if [ "$alt_touchpad_config" -eq 1 ]; then
	cat >/system/etc/gesture/40-touchpad-cmt.conf <<TOUCHPADFIX
