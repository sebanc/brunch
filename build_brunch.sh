...
if [ -f ../chromiumos-stage3/chromiumos_stage3.tar.gz ]; then
	...
	curl -L https://github.com/sebanc/chromiumos-stage3/releases/download/r145-20260228/chromiumos_stage3_r145_20260228.tar.gz -o ./out/chromiumos_stage3.tar.gz || { echo "Failed to download the brunch toolchain"; exit 1; }
fi
...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/reven/16552.47.0/stable-channel/chromeos_16552.47.0_reven_stable-channel_full_RevenMPKeys-v10.bin-gy4tszlbgvtdqxjjznwyr6zxnmjv7acb.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
