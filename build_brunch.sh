...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/rammus/16151.53.0/stable-channel/chromeos_16151.53.0_rammus_stable-channel_full_RammusMPKeys-v7.bin-gy3wezldmrswkemhdav472w3vouzargg.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
