# Detect USB cameras based on uvcvideo dmesg output and create the corresponding generic config
# Note: The uvcvideo driver needs to be builtin the kernel for this to work
