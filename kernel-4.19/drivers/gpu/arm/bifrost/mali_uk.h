 ...
 * drivers developed as part of the Bifrost DDK. Currently that includes the Base driver.
 *
 ...
 *
 * This API is internal to the Bifrost DDK and is not exposed to any applications.
 *
 * @{
 */
