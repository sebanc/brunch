...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/rammus/16181.44.0/stable-channel/chromeos_16181.44.0_rammus_stable-channel_full_RammusMPKeys-v7.bin-gy3win3dg4ztlgr47ibx2lmbb32n2g7x.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
