...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/reven/16640.57.0/stable-channel/chromeos_16640.57.0_reven_stable-channel_full_RevenMPKeys-v10.bin-gzqtczbrmztgm24oi57h5twmyl4nbkx2.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
