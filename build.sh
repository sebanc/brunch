...
cd rootfs
curl -L https://dl.google.com/chromeos/rammus/14526.57.0/stable-channel/chromeos_14526.57.0_rammus_stable-channel_full_mp-v2.bin-gyzdinbqgqzgnv4xkilvyyxe6uwbg2uw.signed -o ./update.signed
...
git clone --depth=1 -b main https://git.kernel.org/pub/scm/linux/kernel/git/firmware/linux-firmware.git
cd ./linux-firmware
...
#cp /persist/brunch-toolchain/toolchain/brunch_toolchain.tar.gz ./chroot/home/chronos/
