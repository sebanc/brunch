...
#if defined(CONFIG_MALI_VALHALL_DEVFREQ) && defined(CONFIG_DEVFREQ_THERMAL)
...
#else /* !(defined(CONFIG_MALI_VALHALL_DEVFREQ) && defined(CONFIG_DEVFREQ_THERMAL)) */

static inline void kbase_ipa_protection_mode_switch_event(struct kbase_device *kbdev)
{ }

#endif /* (defined(CONFIG_MALI_VALHALL_DEVFREQ) && defined(CONFIG_DEVFREQ_THERMAL)) */
