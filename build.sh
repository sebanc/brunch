...
kernels="4.19 5.4 5.10 chromebook-4.4 chromebook-5.4 macbook"
...
cd rootfs
curl -L https://dl.google.com/chromeos/rammus/14150.64.0/stable-channel/chromeos_14150.64.0_rammus_stable-channel_full_mp-v2.bin-gyytmzlbmuytjvljzr7xtnxcovbxxebf.signed -o ./update.signed
...
cp -r ./efi-partition ./chroot/home/chronos/image/
...
mkdir -p ./chroot/home/chronos/initramfs/sbin
cp ./scripts/brunch-init ./chroot/home/chronos/initramfs/init
cp ./scripts/brunch-setup ./chroot/home/chronos/initramfs/sbin/
cp ./scripts/brunch-hwprobe ./chroot/home/chronos/initramfs/sbin/
cp -r ./bootsplashes ./chroot/home/chronos/initramfs/
...
cp -r ./external-drivers/backport-iwlwifi-core63 ./chroot/tmp/backport-iwlwifi
...
cd ./chroot/home/chronos
cp -r ../../../alsa-ucm-conf ./
cd ./alsa-ucm-conf
tar zcf ../rootc/packages/alsa-ucm-conf.tar.gz * --owner=0 --group=0
cd ..
rm -r ./alsa-ucm-conf

git clone --depth=1 -b master git://git.kernel.org/pub/scm/linux/kernel/git/firmware/linux-firmware.git
cd ./linux-firmware
make DESTDIR=./tmp FIRMWAREDIR=/lib/firmware install
mv ./tmp/lib/firmware ./out
rm -r ./out/bnx2x
rm -r ./out/dpaa2
rm -r ./out/liquidio
rm -r ./out/mellanox
...
rm -r ./out/qcom
rm -r ./out/qed
rm -r ./out/ti-connectivity
rm ./out/*.pnvm
curl -L https://git.kernel.org/pub/scm/linux/kernel/git/sforshee/wireless-regdb.git/plain/regulatory.db -o ./out/regulatory.db
curl -L https://git.kernel.org/pub/scm/linux/kernel/git/sforshee/wireless-regdb.git/plain/regulatory.db.p7s -o ./out/regulatory.db.p7s
cp -r ../../../../extra-firmwares/* ./out/
mkdir -p ../rootc/lib/firmware
mv ./out/amd-ucode.img ./out/intel-ucode.img ../rootc/lib/firmware/
cd ./out
tar zcf ../../rootc/packages/firmwares.tar.gz * --owner=0 --group=0
cd ../..
rm -r ./linux-firmware
cd ../../..
