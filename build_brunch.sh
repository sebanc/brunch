...
if [ -f ../chromiumos-stage3/chromiumos_stage3.tar.gz ]; then
	...
	curl -L https://github.com/sebanc/chromiumos-stage3/releases/download/r144-20260117/chromiumos_stage3_r144_20260117.tar.gz -o ./out/chromiumos_stage3.tar.gz || { echo "Failed to download the brunch toolchain"; exit 1; }
fi
...
if [ ! -z $1 ] && [ "$1" != "skip" ] ; then
	...
	cd rootfs
	curl -L https://dl.google.com/chromeos/reven/16503.60.0/stable-channel/chromeos_16503.60.0_reven_stable-channel_full_RevenMPKeys-v8.bin-gy4tonzrmjsdcz5rklpmzb5mpmllam6m.signed -o ./update.signed || { echo "Failed to Download the OTA update"; exit 1; }
