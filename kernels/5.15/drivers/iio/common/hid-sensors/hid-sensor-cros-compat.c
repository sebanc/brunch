...
static int hid_als_probe(struct platform_device *pdev)
{
	...
	static const u32 als_sensitivity_addresses[] = { HID_USAGE_SENSOR_DATA_LIGHT, };
	...
	ret = devm_iio_kfifo_buffer_setup_ext(&pdev->dev, indio_dev, INDIO_BUFFER_SOFTWARE, NULL, cros_compat_attributes);
	if (ret) {
