...
struct cam_ir_led_func {
	int32_t (*camera_ir_led_init)(struct cam_ir_led_ctrl *led_ctrl);
	int32_t (*camera_ir_led_release)(struct cam_ir_led_ctrl *led_ctrl);
	int32_t (*camera_ir_led_off)(struct cam_ir_led_ctrl *led_ctrl);
	int32_t (*camera_ir_led_on)(struct cam_ir_led_ctrl *led_ctrl,
		struct cam_ir_led_set_on_off *oper);
};
